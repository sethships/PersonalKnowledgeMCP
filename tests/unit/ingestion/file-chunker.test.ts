...
describe("FileChunker", () => {
  ...
  describe("Configuration", () => {
    ...
    test("loads from environment variables", () => {
      ...
      try {
        ...
        // Clean up - always runs even if test throws
  ...
  describe("Small Files", () => {
    ...
    test("single chunk has correct metadata", () => {
      const chunker = new FileChunker();
      const fileInfo = createMockFileInfo({
  ...
  describe("Large Files", () => {
    ...
    test("all chunks have correct totalChunks", () => {
      const chunker = new FileChunker({ maxChunkTokens: 100, overlapTokens: 20 });
      const content = MEDIUM_FILE_CONTENT;
      const fileInfo = createMockFileInfo({ sizeBytes: content.length });
  ...
  describe("Overlap Behavior", () => {
    ...
    test("overlap provides content continuity", () => {
  ...
  describe("Edge Cases", () => {
    test("very long single line is handled", () => {
    ...
    test("file with no final newline", () => {
      const chunker = new FileChunker();
    ...
    test("chunk limit is enforced (truncates to 100)", () => {
  ...
  describe("Token Estimation", () => {
    ...
    test("respects maxChunkTokens limit", () => {
  ...
  describe("Error Handling", () => {
    test("throws ChunkingError on unexpected error", () => {
      const chunker = new FileChunker();
    ...
    test("ChunkingError includes file path", () => {
      const chunker = new FileChunker();
      const invalidFileInfo = null as unknown as FileInfo;
  ...
  describe("Integration", () => {
    test("chunks realistic code file correctly", () => {
    ...
    test("handles multiple files with same chunker instance", () => {
      const chunker = new FileChunker();
