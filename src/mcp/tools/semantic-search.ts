    ...
    properties: {
      ...
      language: {
        ...
        description:
          ...
          "Note: Language filtering uses post-search filtering by file extension. " +
          "If your corpus is dominated by other languages, you may receive fewer results than requested.",
      },
    },
    required: ["query"],
  },
